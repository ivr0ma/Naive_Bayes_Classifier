...
def classify(texts, PosDict, NegDict, PosDocs, NegDocs):
    # ==================================================================================================================
    # -- Подсчет вероятности (биномиальный классификатор) --------------------------------------------------------------
    # ==================================================================================================================
    def Binom(PosDict, NegDict, doc, PosProb, NegProb, AllPos, AllNeg):
        posver = log(PosProb)
        smas = set(doc)
    ...
    for line in texts:
        ...
        doc = doc.split()  # -- разбиваем на слова
        doc = Preparing(doc)
        res = Binom(PosDict, NegDict, doc, PosProb, NegProb, AllPos, AllNeg)
        label.append(res)
        if counter % 100:
